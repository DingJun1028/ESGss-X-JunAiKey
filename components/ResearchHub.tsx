        ...
        <div>
          ...
          <div className="flex gap-4 border-b border-white/10">
              <button 
                ...
                className={`pb-2 text-sm font-medium transition-colors ${activeTab === 'explorer' ? 'text-celestial-emerald border-b-2 border-celestial-emerald' : 'text-gray-400 hover:text-white'}`}
              >
                  {t.dataExplorer}
              </button>
              <button 
                onClick={() => setActiveTab('scanner')}
                className={`pb-2 text-sm font-medium transition-colors flex items-center gap-2 ${activeTab === 'scanner' ? 'text-celestial-purple border-b-2 border-celestial-purple' : 'text-gray-400 hover:text-white'}`}
              >
