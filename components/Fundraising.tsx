...
import { Heart, Globe, ArrowRight, Coins, Users, Target } from 'lucide-react';
...
export const Fundraising: React.FC<FundraisingProps> = ({ language }) => {
  ...
  const projects = [
      ...
      },
      {
          ...
          desc: isZh ? '每捐贈 100 GWC 可種植一棵原生樹木，保護生物多樣性。' : 'Plant native trees to restore biodiversity. 100 GWC = 1 Tree.',
          target: 100000,
          current: 68900,
          image: 'https://images.unsplash.com/photo-1542601906990-b4d3fb7d5b7e?w=500&q=80',
      ...
      },
      {
          ...
          desc: isZh ? '為偏鄉學校提供太陽能設備與永續課程教材。' : 'Providing solar kits and sustainability curriculum to rural schools.',
          target: 25000,
          current: 12050,
                ...
                return (
                    <div key={project.id} className="glass-panel rounded-2xl overflow-hidden flex flex-col group border-white/10 hover:border-white/20 transition-all">
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            <div className="text-xs text-gray-400 mb-1">{project.org}</div>
